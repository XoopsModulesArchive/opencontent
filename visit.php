...
$xoopsDB->queryF($sql);
$result = $xoopsDB->query('select url from ' . $xoopsDB->prefix('opencontent_links') . " where lid=$lid and status>0");
...
//		<frame src='".htmlspecialchars($url)."' frame name='main' scrolling='auto' target='Main'>
//		</frameset></html>";
// } else {
...
echo '<IFRAME src="' . $url . '" width="750" height="1000" frameborder="0">';
echo 'Il tuo browser non supporta i Frame in linea. <A HREF="' . $url . '">Clicca qui</A>';
echo '</IFRAME>';
